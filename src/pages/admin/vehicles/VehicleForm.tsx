          ...
          <div className="grid gap-6 lg:grid-cols-2">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="e.g., Volvo 45 Seater" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea rows={3} placeholder="Vehicle description..." {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Starting price for the vehicle</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  control={form.control}
                  name="outstation_allowance"
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Outstation Allowance</FormLabel>
                      <FormControl>
                        <Input placeholder="e.g., 300 km/day" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
