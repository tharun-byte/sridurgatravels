  ...
  return (
    <div className="fixed bottom-20 lg:bottom-6 right-4 z-40 flex flex-col gap-3">
      ...
      <a
        ...
        className={cn(
          "group flex items-center justify-center w-14 h-14 rounded-full shadow-lg transition-all duration-300",
          "bg-[#25D366] hover:bg-[#128C7E] hover:scale-110 hover:shadow-xl",
          "animate-pulse-soft"
        )}
      ...
      <a
        ...
        className={cn(
          "group flex items-center justify-center w-14 h-14 rounded-full shadow-lg transition-all duration-300",
          "bg-primary hover:bg-primary/90 hover:scale-110 hover:shadow-xl hover:shadow-primary/40"
        )}
        aria-label="Call us"
      >
        <Phone className="w-6 h-6 text-white transition-transform duration-300 group-hover:rotate-12" />
      </a>
    </div>
  );
}
